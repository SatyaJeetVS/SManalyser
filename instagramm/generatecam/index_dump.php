        ...
        <div class="container-fluid"><a class="navbar-brand" href="#">Social Media Analysis</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="#">Generate Campaign</a></li>
  ...
  <label for="video"> Post Video </label><br> -->
    ...
    <div class="center">
        <form method="post" action="insertdata.php">
            ...
            <div class="mb-3"><button class="btn btn-danger d-block w-100" type="submit">Add</button></div>
...
<button class="btn btn-primary d-block w-100" id="sug" data-bs-toggle="popover " title="Popover title" data-bs-content="trending Hashtags" data-bs-toggle="modal" data-bs-target="#exampleModal">Suggest hashtag</button>
<form action="posting_content.php">
    <div class="mb-3"><button class="btn btn-danger d-block w-100" type="submit">Post all</button></div>
</form>
    
</div><div class ="box" id="hassuggest"></div>
    <!-- Modal -->
...
"https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js">
    ...
    <?php 
    include 'db.php';
    $sql = "SELECT url,caption FROM camp";
...
if ($result->num_rows > 0) {
  ...
  echo "Queue empty or all posts are posted";
}
$conn->close();?>
    <script src="assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="assets/js/bs-init.js"></script>
