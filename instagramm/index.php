...
<nav class="navbar navbar-light navbar-expand-lg bg-info navigation-clean">
        <div class="container-fluid"><a class="navbar-brand" href="#">Social Media Analysis</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <li class="nav-item"><a class="nav-link" href="../selectapp.php">Select App</a></li>
...
<div class="row">
              ...
              <div class="container" style="width: 650px;height: 800px;margin-left: 350px;margin-right: 0;margin-top:-200px">
...
$c=1;
        ...
        <div style="width:100%;display:inline-block">
                ...
                for ($i = 0; $i < 10; $i++) {
                    if($max_likes<$responseArray["business_discovery"]["media"]["data"][$i]["like_count"]){
                         
                        $max_likes =  $responseArray["business_discovery"]["media"]["data"][$i]["like_count"];
                ...
                for ($c = 0; $c < 10; $c++) {
                    if($max_likes==$responseArray["business_discovery"]["media"]["data"][$c]["like_count"]){
                    if ($responseArray['business_discovery']['media']['data'][$c]['media_type']== 'VIDEO'){
                    echo '
                        <video height="300" width="500" controls="">
                        <source src="' . $responseArray["business_discovery"]["media"]["data"][$c]["media_url"] . '">
                        ...
                        echo '<img width="500px" height="300px" src="'.$responseArray['business_discovery']['media']['data'][$c]['media_url'].'">';
                    }
                    echo'
      ...
      ' . $responseArray["business_discovery"]["media"]["data"][$c]["caption"] . ' <br>Likes ' . $max_likes . '
   ...
   ';
    ...
    <body>
        ...
        <form action="comments_and_replies.php" method="post">
            <input type="hidden" value="' . $responseArray['business_discovery']['media']['data'][$c]['id'] . '" name="id">
            <input type="hidden" value="' . $responseArray['business_discovery']['media']['data'][$c]['caption'] . '" name="caption">
            <input type="hidden" value="' . $responseArray['business_discovery']['media']['data'][$c]['media_url'] . '" name="media_url">
            <input type="hidden" value="' . $responseArray['business_discovery']['media']['data'][$c]['permalink'] . '" name="permalink">
            <input type="hidden" value="' . $responseArray['business_discovery']['media']['data'][$c]['media_type'] . '" name="media_type">
    
    
        

  <!-- Button trigger modal -->
  <div><button onclick="func()" type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
    View More
</button> <span id="demo2"></span></div>
...
$sql = "SELECT user_id, followers,date,impressions,reach FROM data where user_id= $id and year(date)= 2021";
...
<div class="col-4" style="height: 250px; margin-top: 380px; margin-left: -190px">
<?php 
...
?> 
    ...
    <div class="col-4" style="height: 250px;margin-left: 510px;margin-top: -250px;">
...
?>
    ...
    <div class="col-4" style="height: 250px;margin-left: 810px;margin-top: -250px;">
